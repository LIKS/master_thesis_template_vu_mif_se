...
\printbibliography  % Šaltinių sąraše nurodoma panaudota literatūra, kitokie
% šaltiniai. Abėcėlės tvarka išdėstomi darbe panaudotų (cituotų, perfrazuotų ar
% bent paminėtų) mokslo leidinių, kitokių publikacijų bibliografiniai aprašai.
% Šaltinių sąrašas spausdinamas iš naujo puslapio. Aprašai pateikiami
% netransliteruoti.
